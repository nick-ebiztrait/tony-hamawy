...
$( ".faq_box" ).each(function( index ) {
  $(this).find(".faq_heading").click(function(){
      $(this).toggleClass("active_faq")
      $(this).siblings(".faq_text").slideToggle();
      $(this).parent(".faq_box").siblings(".faq_box").find(".faq_heading").removeClass("active_faq");
      $(this).parent(".faq_box").siblings(".faq_box").find(".faq_text").slideUp();
  });
});
